...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.original_entropy_label      = self.__get_label("Entropy: ?.??", 12, underline=True)
        self.original_sharpness_brenner_label          = self.__get_label("sharpness: ?.??", 11, underline=True)
        self.original_varience_label     = self.__get_label("varience: ?.??", 11, underline=True)
        self.original_color_hist_btn     = self.__get_color_hist_btn()
        self.upscaled_entropy_label      = self.__get_label("Entropy: ?.??", 12, underline=True)
        self.upscaled_sharpness_brenner_label          = self.__get_label("sharpness: ?.??", 11, underline=True)
        self.upscaled_varience_label     = self.__get_label("varience: ?.??", 11, underline=True)
        ...
        self.upscaled_color_hist_btn.clicked.connect(self.__on_upscaled_hist_btn_clicked)
        ...
        layout.addWidget(self.choose_algorithm_label, 3, 0, 1, 2)
        layout.addWidget(self.algorithm_combobox, 4, 0, 1, 1)
        layout.addWidget(self.run_upscale_label, 5, 0, 1, 2)
        layout.addWidget(self.upscale_btn, 6, 0, 1, 1)'''
    ...
    def __get_label(self, text, font_size, is_bold=False, underline=False, align_center=True):
    ...
    def __get_original_image(self):
        ...
        image_pixmap = image_pixmap.scaled(600, self.app_image.app_image_height*600/self.app_image.app_image_width)
    ...
    def __get_upscaled_image(self):
        ...
        image_pixmap = image_pixmap.scaled(600, self.app_image.upscaled_app_image.app_image_height*600/self.app_image.upscaled_app_image.app_image_width)
        label.setPixmap(image_pixmap)
        label.setAlignment(Qt.AlignCenter)
        return label
    ...
    def __update_app_images(self):
        ...
        print(self.app_image.app_image_height)
        print(self.app_image.app_image_width)
        original_image_pixmap = original_image_pixmap.scaled(600, self.app_image.app_image_height*600/self.app_image.app_image_width)
        ...
        upscaled_image_pixmap = upscaled_image_pixmap.scaled(600, self.app_image.upscaled_app_image.app_image_height*600/self.app_image.upscaled_app_image.app_image_width)
        self.upscaled_image.setPixmap(upscaled_image_pixmap)
        self.__update_measurements()
        

    def __update_measurements(self):
        self.original_entropy_label.setText("Entropy: " + str(self.app_image.get_entropy()))
        self.original_sharpness_brenner_label.setText("sharpness: " + str(self.app_image.get_sharpness_brenner()))
        self.original_varience_label.setText("varience: " + str(self.app_image.get_varience()))
        self.upscaled_entropy_label.setText("Entropy: " + str(self.app_image.upscaled_app_image.get_entropy()))
        self.upscaled_sharpness_brenner_label.setText("sharpness: " + str(self.app_image.upscaled_app_image.get_sharpness_brenner()))
        self.upscaled_varience_label.setText("varience: " + str(self.app_image.upscaled_app_image.get_varience()))
